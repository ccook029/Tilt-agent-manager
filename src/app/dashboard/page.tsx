      ...
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div className="flex items-center gap-4">
          ...
          <h2 className="font-display text-3xl font-bold uppercase tracking-wide">
            Operations <span className="text-[#00d6ff]">Dashboard</span>
          </h2>
        </div>
        <Magnetic>
          <button
      ...
      <div className="flex flex-col sm:flex-row sm:items-center gap-3">
        <div className="relative flex-1">
          ...
          <input
            ...
            className="w-full bg-[#111]/60 border border-gray-800/60 focus:border-[#00d6ff]/40 rounded-lg pl-9 pr-3 py-2 text-sm text-gray-200 placeholder:text-gray-600 outline-none transition-colors"
          />
        </div>
            ...
            <button
              ...
              className={`px-3 py-1.5 rounded-full text-xs font-medium border transition-colors ${
                statusFilter === chip.value
                  ? "bg-[#00d6ff]/15 border-[#00d6ff]/50 text-[#7be9ff]"
            ...
            {filteredIds.map((id, i) => {
              ...
              return (
                <MotionLink
                  ...
                  className="group block rounded-xl border border-gray-800/60 hover:border-[#00d6ff]/30 bg-[#111]/40 hover:bg-[#111]/70 transition-[background-color,border-color,box-shadow] duration-300 hover:shadow-[0_16px_44px_-18px_rgba(0,214,255,0.4)] overflow-hidden relative"
                >
