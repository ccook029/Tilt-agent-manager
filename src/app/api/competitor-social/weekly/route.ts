...
//
// Vercel Cron calls GET every Monday at 10:00 UTC (6 AM ET).
// POST accepts manual triggers with optional context.
// ---------------------------------------------------------------------------
...
async function runSocialIntelReport(context?: string) {
  const startedAt = new Date();

  // Scrape competitor social media via Apify
